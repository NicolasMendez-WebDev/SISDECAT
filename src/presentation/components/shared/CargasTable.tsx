        ...
        <thead className="bg-slate-50 text-slate-500 text-[10px] uppercase font-bold tracking-wider">
          <tr>
            ...
            <th className="p-4 align-top w-auto resizable-th">
              ...
              <select
                className="w-full px-2 py-1 text-xs border border-slate-200 rounded text-slate-700 font-normal focus:outline-none focus:border-institutional-blue truncate max-w-[150px] xl:max-w-[200px]"
            ...
            <th className="p-4 align-top w-auto resizable-th">
              ...
              <select
                className="w-full px-2 py-1 text-xs border border-slate-200 rounded text-slate-700 font-normal focus:outline-none focus:border-institutional-blue truncate max-w-[180px] xl:max-w-[240px]"
            ...
            {!isFuncionario && (
              <th className="p-4 align-top w-auto resizable-th">
                ...
                <select
                  className="w-full px-2 py-1 text-xs border border-slate-200 rounded text-slate-700 font-normal focus:outline-none focus:border-institutional-blue truncate max-w-[120px] xl:max-w-[160px]"
                  value={filters.autor}
            ...
            return (
              <tr key={carga.id} className="hover:bg-slate-50/80 transition-colors">
                ...
                {!isFuncionario && (
                  <td className="p-4 max-w-0">
                    <span 
                      className="bg-slate-100 text-slate-600 px-2 py-1 rounded text-[10px] font-bold tracking-wider block align-middle whitespace-normal break-words"
