        ...
        <div className="max-w-2xl mx-auto flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12 text-center text-xs text-slate-800 px-8 py-3">
          <div className="flex items-center gap-4">
            <div className="flex items-center text-institutional-blue">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 shrink-0" preserveAspectRatio="none" viewBox="0 0 2048 2016" display="block">
                <path fill="#ffffff" d="M 0 0 L 2048 0 L 2048 63.2388 L 2048 1970.18 L 2048 2016 L 0 2016 L 0 0 z" className="colorffffff svgShape"></path>
                <path fill="#f4f4f4" d="M 0 0 L 2048 0 L 2048 63.2388 C 2034.69 41.0589 2022.45 28.1794 1994.89 27.0488 C 1978.95 26.3949 1963.53 26.3196 1947.57 26.3278 L 1857.49 26.3952 L 1498.07 26.3912 L 539.499 26.3828 L 222.372 26.4107 C 171.872 26.4143 121.442 26.3967 70.8703 26.297 C 45.7602 26.2474 23.6061 37.8864 11.8179 60.6641 C 4.73151 74.3568 4.99478 86.5094 4.85905 101.497 C 4.77605 110.662 4.80615 119.929 4.82209 129.135 L 4.86643 219.979 L 4.83217 588.266 L 4.72315 1520.5 L 4.76154 1773.02 C 4.52738 1809.52 4.54119 1846.01 4.80296 1882.51 C 4.82663 1898.41 4.38182 1914.31 4.5985 1930.16 C 4.8553 1948.94 5.13211 1963.26 16.5092 1979.16 C 39.3009 2011.01 85.385 2003.98 119.565 2003.93 L 246.646 2004.02 L 701.526 2003.95 L 1566.23 2004 L 1854.1 2003.97 L 1943.24 2003.95 C 1987.26 2004.05 2021.8 2012.31 2048 1970.18 L 2048 2016 L 0 2016 L 0 0 z" className="colorf4f4f4 svgShape"></path>
